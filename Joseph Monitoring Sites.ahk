...
^#j::Send(
    ...
    "Can we resolve the issue Remotely? (Y or N) `n"
...
f8::{
    ...
    WinWait("Google Chrome", , 10)
        ...
        Sleep 200
        Run "https://der-dashboard-cust.duke-energy.app/home"
        Sleep 200
        ...
        Sleep 200
        ;Site List
        Run "https://docs.google.com/spreadsheets/d/1GdO46Jt304OLf-H-dGJ3MQQUbGbd8lEUAuOewhDdIWM/edit?gid=1126541456#gid=1126541456"
        Sleep 200
        ;Underperformances
